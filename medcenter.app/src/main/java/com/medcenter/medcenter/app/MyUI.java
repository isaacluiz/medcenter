...
@SpringUI
@SpringViewDisplay
public class MyUI extends UI implements ViewDisplay, UriFragmentChangedListener {
	...
	protected void init(VaadinRequest request) {
		...
		getUI().getPage().addPopStateListener(source -> System.out.println(source.getUri()));
	}
	...
	public void uriFragmentChanged(UriFragmentChangedEvent event) {
		System.out.println(event.getUriFragment());
	}
}
